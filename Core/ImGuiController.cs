...
namespace EZImGui.Core
{
    public class ImGuiController : IDisposable
    {
        ...
        public ImGuiController(int width, int height)
        {
            ...
            KHRDebugAvailable = (major == 4 && minor >= 3) || OpenGLRenderer.IsExtensionSupported("KHR_debug");
        ...
        public void CreateDeviceResources()
        {
            ...
            OpenGLRenderer.LabelObject(ObjectLabelIdentifier.VertexArray, _vertexArray, "ImGui");

            _vertexBuffer = GL.GenBuffer();
            GL.BindBuffer(BufferTarget.ArrayBuffer, _vertexBuffer);
            OpenGLRenderer.LabelObject(ObjectLabelIdentifier.Buffer, _vertexBuffer, "VBO: ImGui");
            GL.BufferData(BufferTarget.ArrayBuffer, _vertexBufferSize, IntPtr.Zero, BufferUsageHint.DynamicDraw);

            _indexBuffer = GL.GenBuffer();
            GL.BindBuffer(BufferTarget.ElementArrayBuffer, _indexBuffer);
            OpenGLRenderer.LabelObject(ObjectLabelIdentifier.Buffer, _indexBuffer, "EBO: ImGui");
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
            ...
            _shader = OpenGLRenderer.CreateProgram("ImGui", VertexSource, FragmentSource);
        ...
        public void RecreateFontDeviceTexture()
        {
            ...
            OpenGLRenderer.LabelObject(ObjectLabelIdentifier.Texture, _fontTexture, "ImGui Text Atlas");
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            Logger.Debug($"Font Location: {_shaderFontTextureLocation}");
            Logger.Debug($"Projection Location: {_shaderFontTextureLocation}");
